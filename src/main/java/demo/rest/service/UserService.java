...
public class UserService {
	...
	public User getUserById(@PathParam("id") int id, @Context Request req) 
	{
		if (req.getMethod().equals("GET")) 
		{
            Response.ResponseBuilder rb = req.evaluatePreconditions(new Date());
            if (rb != null) 
            {
